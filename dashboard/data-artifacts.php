...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['action']) && $_POST['action'] == "add") {
  ...
  $rarity = htmlspecialchars(trim($_POST['rarity']));
  $p2 = htmlspecialchars(trim($_POST['2p']));
  $p4 = htmlspecialchars(trim($_POST['4p']));

  $stmt = $conn->prepare("INSERT INTO artifacts (game, gambar, nama, rarity, 2p, 4p) VALUES (?, ?, ?, ?, ?, ?)");
  $stmt->bind_param("ssssss", $game, $gambar, $nama, $rarity, $p2, $p4);
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['action']) && $_POST['action'] == "edit") {
  ...
  $stmt = $conn->prepare("UPDATE artifacts SET gambar = ?, nama = ?, rarity = ?, 2p = ?, 4p = ? WHERE id = ?");
  $stmt->bind_param("sssssi", $gambar, $nama, $rarity, $p2, $p4, $id);
      ...
      <main class="app-main">
        ...
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-6"><h3 class="mb-0">Data Artifacts "<?php echo htmlspecialchars($_GET['id']); ?>"</h3></div>
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-end">
                  <li class="breadcrumb-item"><a href="../dashboard">Beranda</a></li>
                  <li class="breadcrumb-item active" aria-current="page">Data Artifacts</li>
                </ol>
              </div>
            </div>
            <!--end::Row-->
                              ...
                              <td>
                                <?php
                                  ...
                                  if (filter_var($gambar, FILTER_VALIDATE_URL)) {
                                      ...
                                      echo '<a href="../public/images/senjata/' . $gambar . '" target="_BLANK">Click Here</a>';
                                  }
                                ?>
                              </td>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form id="formModal" action="data-artifacts.php?id=<?php echo urlencode($_GET['id']); ?>" method="POST">
                  ...
                  <div class="mb-3">
                    ...
                    <input type="number" id="rarity" name="rarity" class="form-control" required>
                  </div>
                  <div class="mb-3">
                    <label for="2p" class="form-label">2-Piece Bonus</label>
                    <input type="text" id="2p" name="2p" class="form-control" required>
                  </div>
                  <div class="mb-3">
                    <label for="4p" class="form-label">4-Piece Bonus</label>
                    <input type="text" id="4p" name="4p" class="form-control" required>
                  </div>
    ...
    <script>
      ...
      function openModal(action, data = null) {
          ...
          if (action === "edit" && data) {
              ...
              document.getElementById('2p').value = data['2p'];
              document.getElementById('4p').value = data['4p'];
          } else {
