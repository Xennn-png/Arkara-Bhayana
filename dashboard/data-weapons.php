...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['action']) && $_POST['action'] == "add") {
  ...
  $secondary = htmlspecialchars(trim($_POST['secondary']));
  $status = htmlspecialchars(trim($_POST['status']));

  $stmt = $conn->prepare("INSERT INTO weapons (game, gambar, nama, type, rarity, attack, secondary, status) VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
  $stmt->bind_param("ssssssss", $game, $gambar, $nama, $type, $rarity, $attack, $secondary, $status);
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['action']) && $_POST['action'] == "edit") {
  ...
  $stmt = $conn->prepare("UPDATE weapons SET gambar = ?, nama = ?, type = ?, rarity = ?, attack = ?, secondary = ?, status = ? WHERE id = ?");
  $stmt->bind_param("sssssssi", $gambar, $nama, $type, $rarity, $attack, $secondary, $status, $id);
      ...
      <main class="app-main">
        ...
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-6"><h3 class="mb-0">Data Weapons "<?php echo htmlspecialchars($_GET['id']); ?>"</h3></div>
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-end">
                  <li class="breadcrumb-item"><a href="../dashboard">Beranda</a></li>
                  <li class="breadcrumb-item active" aria-current="page">Data Weapons</li>
                </ol>
              </div>
            </div>
            <!--end::Row-->
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form id="formModal" action="data-weapons.php?id=<?php echo urlencode($_GET['id']); ?>" method="POST">
    ...
    <script>
      ...
      function openModal(action, data = null) {
          ...
          if (action === "edit" && data) {
              ...
              document.getElementById('secondary').value = data.secondary;
