...
// if($login_berhasil) {
//     session_start();
//     $_SESSION['username'] = $username; // username yang diinput saat login
...
<body>
    <div class="background-video-container" id="background-video-container">
        ...
        <div class="login-container">
            ...
            <p>Belum punya akun? <a href="./registrasi.php" class="register-link">Registrasi Sekarang!</a></p>
            <p>Anda Developer? <a href="./admin.php" class="register-link">Login
                    Admin Sekarang!</a>
            </p>
        </div>
    </div>
